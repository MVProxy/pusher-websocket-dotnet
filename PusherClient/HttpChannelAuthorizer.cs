...
{
    /// <summary>
    /// An implementation of the <see cref="IChannelAuthorizer"/> using Http
    /// </summary>
    public partial class HttpChannelAuthorizer: IChannelAuthorizer, IChannelAuthorizerAsync
    {
        ...
        public HttpChannelAuthorizer(string authEndpoint)
        {
